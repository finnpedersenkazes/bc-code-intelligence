...
relevance_signals:
  constructs: ["GetSentEmailsForRecord", "Email", "AddRelation", "OnGetTestEmailBody"]
  keywords: []
  anti_pattern_indicators: ["Email.GetSentEmailsForRecord", "Email.AddRelation", "Email.OnGetTestEmailBody"]

---
title: "Mail Management - 10 Obsoletions"
...
relevance_signals:
  constructs: ["SetHideSMTPError", "Mail Management", "MailManagement", "IsSMTPEnabled", "Send", "AssignFromAddressIfExist", "SendMailOrDownload", "GetSenderEmailAddress", "GetSMTPCredentials", "OnAfterSentViaSMTP", "OnBeforeSentViaSMTP", "OnSendViaSMTPOnBeforeSMTPMailAddAttachment"]
  keywords: []
  anti_pattern_indicators: ["Mail Management.SetHideSMTPError", "Mail Management.IsSMTPEnabled", "Mail Management.Send", "Mail Management.AssignFromAddressIfExist", "Mail Management.SendMailOrDownload", "Mail Management.GetSenderEmailAddress", "Mail Management.GetSMTPCredentials", "Mail Management.OnAfterSentViaSMTP", "Mail Management.OnBeforeSentViaSMTP", "Mail Management.OnSendViaSMTPOnBeforeSMTPMailAddAttachment"]
  positive_pattern_indicators: ["the overload containing Email Scenario."]

applicable_object_types: ["codeunit"]
relevance_threshold: 0.6
---
# Mail Management - 10 Obsoletions
...
### procedure `OnAfterSentViaSMTP`
{'Object': 'Mail Management', 'State': 'Pending', 'Tag': '19.3', 'Reason': 'SMTP Mail codeunit has been obsolete'}

### procedure `OnBeforeSentViaSMTP`
{'Object': 'Mail Management', 'State': 'Pending', 'Tag': '19.3', 'Reason': 'SMTP Mail codeunit has been obsolete'}

### procedure `OnSendViaSMTPOnBeforeSMTPMailAddAttachment`
{'Object': 'Mail Management', 'State': 'Pending', 'Tag': '19.3', 'Reason': 'SMTP Mail codeunit has been obsolete'}

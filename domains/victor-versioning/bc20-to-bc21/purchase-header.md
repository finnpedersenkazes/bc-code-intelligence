...
relevance_signals:
  constructs: ["Last Return Shipment No.", "Purchase Header", "PurchaseHeader", "CreateDim", "GetCardpageID", "BatchConfirmUpdateDeferralDate", "LookupBuyfromVendorName", "OnBeforeRunEventOnAfterCreateDimTableIDs", "OnAfterCreateDimTableIDs", "OnValidatePurchaseHeaderPayToVendorNo", "OnBuyFromPostCodeOnBeforeOnLookup"]
  keywords: []
  anti_pattern_indicators: ["Purchase Header.Last Return Shipment No.", "Purchase Header.CreateDim", "Purchase Header.GetCardpageID", "Purchase Header.BatchConfirmUpdateDeferralDate", "Purchase Header.LookupBuyfromVendorName", "Purchase Header.OnBeforeRunEventOnAfterCreateDimTableIDs", "Purchase Header.OnAfterCreateDimTableIDs", "Purchase Header.OnValidatePurchaseHeaderPayToVendorNo", "Purchase Header.OnBuyFromPostCodeOnBeforeOnLookup"]

...
relevance_signals:
  constructs: ["Job Purchase", "Item Ledger Entry", "ItemLedgerEntry", "Variant Code", "Originally Ordered Var. Code"]
  keywords: []
  anti_pattern_indicators: ["Item Ledger Entry.Job Purchase", "Item Ledger Entry.Variant Code", "Item Ledger Entry.Originally Ordered Var. Code"]

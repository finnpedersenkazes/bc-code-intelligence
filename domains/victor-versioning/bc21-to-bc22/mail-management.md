---
title: "Mail Management - 5 Obsoletions"
...
relevance_signals:
  constructs: ["GetLastGraphError", "Mail Management", "MailManagement", "IsGraphEnabled", "Send", "SendMailOrDownload", "OnBeforeRunMailDialog"]
  keywords: []
  anti_pattern_indicators: ["Mail Management.GetLastGraphError", "Mail Management.IsGraphEnabled", "Mail Management.Send", "Mail Management.SendMailOrDownload", "Mail Management.OnBeforeRunMailDialog"]
  positive_pattern_indicators: []

applicable_object_types: ["codeunit"]
relevance_threshold: 0.6
---
# Mail Management - 5 Obsoletions

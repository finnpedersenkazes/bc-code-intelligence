---
title: "Transfer Extended Text - 3 Obsoletions"
...
relevance_signals:
  constructs: ["OnBeforeToSalesLineInsert", "Transfer Extended Text", "TransferExtendedText", "OnBeforeToServiceLineInsert", "OnInsertSalesExtTextRetLastOnBeforeSetCompatibilityMode"]
  keywords: []
  anti_pattern_indicators: ["Transfer Extended Text.OnBeforeToSalesLineInsert", "Transfer Extended Text.OnBeforeToServiceLineInsert", "Transfer Extended Text.OnInsertSalesExtTextRetLastOnBeforeSetCompatibilityMode"]
  positive_pattern_indicators: []

applicable_object_types: ["codeunit"]
relevance_threshold: 0.6
---
# Transfer Extended Text - 3 Obsoletions

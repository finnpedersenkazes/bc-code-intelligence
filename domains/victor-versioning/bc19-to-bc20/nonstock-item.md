...
relevance_signals:
  constructs: ["Gross Weight", "Nonstock Item", "NonstockItem", "Item Template Code"]
  keywords: []
  anti_pattern_indicators: ["Nonstock Item.Gross Weight", "Nonstock Item.Item Template Code"]

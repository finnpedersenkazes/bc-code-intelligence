...
relevance_signals:
  constructs: ["Scheduled Receipt (Qty.)", "Item", "Manufacturer Code", "Use Cross-Docking"]
  keywords: []
  anti_pattern_indicators: ["Item.Scheduled Receipt (Qty.)", "Item.Manufacturer Code", "Item.Use Cross-Docking"]

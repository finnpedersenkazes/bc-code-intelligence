...
relevance_signals:
  constructs: ["Combine Shipments", "Customer", "E-Mail", "Disable Search by Name", "Bill-To No. of Pstd. Cr. Memos", "Payment Method Id", "Key11", "LookupCustomer"]
  keywords: []
  anti_pattern_indicators: ["Customer.Combine Shipments", "Customer.E-Mail", "Customer.Disable Search by Name", "Customer.Bill-To No. of Pstd. Cr. Memos", "Customer.Payment Method Id", "Customer.Key11", "Customer.LookupCustomer"]
  positive_pattern_indicators: []

applicable_object_types: ["table"]
relevance_threshold: 0.6
---
# Customer - 8 Obsoletions

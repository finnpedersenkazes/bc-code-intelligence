...
relevance_signals:
  constructs: ["Maximum No. of Attempts to Run", "Job Queue Entry", "JobQueueEntry", "Run in User Session", "User Session ID", "Job Queue Category Code", "Error Message 3", "Rerun Delay (sec.)", "On Hold Due to Inactivity", "OnScheduleTaskOnAfterCalcShouldChangeUserID"]
  keywords: []
  anti_pattern_indicators: ["Job Queue Entry.Maximum No. of Attempts to Run", "Job Queue Entry.Run in User Session", "Job Queue Entry.User Session ID", "Job Queue Entry.Job Queue Category Code", "Job Queue Entry.Error Message 3", "Job Queue Entry.Rerun Delay (sec.)", "Job Queue Entry.On Hold Due to Inactivity", "Job Queue Entry.OnScheduleTaskOnAfterCalcShouldChangeUserID"]

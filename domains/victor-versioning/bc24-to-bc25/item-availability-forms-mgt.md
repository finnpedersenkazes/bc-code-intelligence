...
{'Object': 'Item Availability Forms Mgt', 'State': 'Pending', 'Tag': '25.0', 'Reason': 'Replaced by procedure ShowItemAvailabiltyFromItem with enum'}

### procedure `ShowItemAvailFromSalesLine`
{'Object': 'Item Availability Forms Mgt', 'State': 'Pending', 'Tag': '25.0', 'Reason': 'Replaced by procedure in Serv. Availability Mgt.'}

### procedure `ShowItemAvailFromPurchLine`
{'Object': 'Item Availability Forms Mgt', 'State': 'Pending', 'Tag': '25.0', 'Reason': 'Replaced by procedure in Purch. Availability Mgt.'}

### procedure `ShowItemAvailFromReqLine`
{'Object': 'Item Availability Forms Mgt', 'State': 'Pending', 'Tag': '25.0', 'Reason': 'Replaced by procedure in Req. Line Availability Mgt.'}

### procedure `ShowItemAvailFromProdOrderLine`
{'Object': 'Item Availability Forms Mgt', 'State': 'Pending', 'Tag': '25.0', 'Reason': 'Replaced by procedure in Prod. Order Availability Mgt.'}
...
{'Object': 'Item Availability Forms Mgt', 'State': 'Pending', 'Tag': '25.0', 'Reason': 'Replaced by procedure in Warehouse Availability Mgt.'}
...
{'Object': 'Item Availability Forms Mgt', 'State': 'Pending', 'Tag': '25.0', 'Reason': 'Replaced by procedure in Assembly Availability Mgt.'}

### procedure `ShowItemAvailFromAsmLine`
{'Object': 'Item Availability Forms Mgt', 'State': 'Pending', 'Tag': '25.0', 'Reason': 'Replaced by procedure in Assembly Availability Mgt.'}

### procedure `ShowItemAvailFromPlanningComp`
{'Object': 'Item Availability Forms Mgt', 'State': 'Pending', 'Tag': '25.0', 'Reason': 'Replaced by procedure in Planning Comp. Avail. Mgt.'}

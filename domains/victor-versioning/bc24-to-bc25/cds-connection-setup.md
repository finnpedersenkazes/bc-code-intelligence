---
title: "CDS Connection Setup - 8 Obsoletions"
...
relevance_signals:
  constructs: ["CDS Connection Setup", "CDSConnectionSetup", "SynchronizeNow", "GetPassword", "SetPassword", "GetAccessToken", "SetAccessToken", "SetClientSecret", "GetClientSecret"]
  keywords: []
  anti_pattern_indicators: ["CDS Connection Setup.SynchronizeNow", "CDS Connection Setup.GetPassword", "CDS Connection Setup.SetPassword", "CDS Connection Setup.GetAccessToken", "CDS Connection Setup.SetAccessToken", "CDS Connection Setup.SetClientSecret", "CDS Connection Setup.GetClientSecret"]
...
---
# CDS Connection Setup - 8 Obsoletions
...
{'Object': 'CDS Connection Setup', 'State': 'Pending', 'Tag': '23.0', 'Reason': 'Obsoleted by flow fields Coupled to Dataverse'}

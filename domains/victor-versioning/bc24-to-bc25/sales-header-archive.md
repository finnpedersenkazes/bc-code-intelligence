...
relevance_signals:
  constructs: ["Area", "Sales Header Archive", "SalesHeaderArchive", "Incoming Document Entry No.", "Rcvd.-from Count./Region Code", "Date Archived", "Campaign No."]
  keywords: []
  anti_pattern_indicators: ["Sales Header Archive.Area", "Sales Header Archive.Incoming Document Entry No.", "Sales Header Archive.Rcvd.-from Count./Region Code", "Sales Header Archive.Date Archived", "Sales Header Archive.Campaign No."]

...
relevance_signals:
  constructs: ["Prepayment Invoice", "Sales Invoice Header", "SalesInvoiceHeader", "Prepayment Order No.", "Last Email Sent Time", "Last Email Sent Status", "Sent as Email", "Last Email Notif Cleared", "Sell-to Phone No.", "Payment Service Set ID", "Opportunity No."]
  keywords: []
  anti_pattern_indicators: ["Sales Invoice Header.Prepayment Invoice", "Sales Invoice Header.Prepayment Order No.", "Sales Invoice Header.Last Email Sent Time", "Sales Invoice Header.Last Email Sent Status", "Sales Invoice Header.Sent as Email", "Sales Invoice Header.Last Email Notif Cleared", "Sales Invoice Header.Sell-to Phone No.", "Sales Invoice Header.Payment Service Set ID", "Sales Invoice Header.Opportunity No."]
...
{'Object': 'Sales Invoice Header', 'State': 'Removed', 'Tag': '24.0', 'Reason': 'Microsoft Invoicing is not supported in Business Central'}

---
title: "Job Create-Invoice - 3 Obsoletions"
...
relevance_signals:
  constructs: ["CreateSalesInvoiceLines", "Job Create-Invoice", "JobCreate-Invoice", "CreateSalesInvoiceJobTask", "OnCreateSalesInvoiceLinesOnBeforeGetCustomer"]
  keywords: []
  anti_pattern_indicators: ["Job Create-Invoice.CreateSalesInvoiceLines", "Job Create-Invoice.CreateSalesInvoiceJobTask", "Job Create-Invoice.OnCreateSalesInvoiceLinesOnBeforeGetCustomer"]
  positive_pattern_indicators: []

applicable_object_types: ["codeunit"]
relevance_threshold: 0.6
---
# Job Create-Invoice - 3 Obsoletions

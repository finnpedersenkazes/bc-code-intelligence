...
relevance_signals:
  constructs: ["Company Bank Account Code", "Sales Header Archive", "SalesHeaderArchive", "Rcvd.-from Count./Region Code", "Date Archived", "Campaign No.", "Sell-to Customer Template Code"]
  keywords: []
  anti_pattern_indicators: ["Sales Header Archive.Company Bank Account Code", "Sales Header Archive.Rcvd.-from Count./Region Code", "Sales Header Archive.Date Archived", "Sales Header Archive.Campaign No.", "Sales Header Archive.Sell-to Customer Template Code"]

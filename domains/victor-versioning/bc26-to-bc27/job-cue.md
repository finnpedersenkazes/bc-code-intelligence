...
relevance_signals:
  constructs: ["Date Filter", "Job Cue", "JobCue", "User ID Filter", "Coupled Data Synch Errors"]
  keywords: []
  anti_pattern_indicators: ["Job Cue.Date Filter", "Job Cue.User ID Filter", "Job Cue.Coupled Data Synch Errors"]
...
### field `Coupled Data Synch Errors`
{'Object': 'Job Cue', 'State': 'Removed', 'Tag': '25.0', 'Reason': 'Field Service is moved to Field Service Integration app.'}

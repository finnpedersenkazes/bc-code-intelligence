...
relevance_signals:
  constructs: ["Sales/Serv. Shpt. Line No.", "Service Item", "ServiceItem", "Shipment Type"]
  keywords: []
  anti_pattern_indicators: ["Service Item.Sales/Serv. Shpt. Line No.", "Service Item.Shipment Type"]

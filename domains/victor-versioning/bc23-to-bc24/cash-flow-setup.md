...
relevance_signals:
  constructs: ["Period Type", "Cash Flow Setup", "CashFlowSetup", "SaveUserDefinedAPIKey", "GetMLCredentials", "RetrieveSaaSMLCredentials", "GetUserDefinedAPIKey"]
  keywords: []
  anti_pattern_indicators: ["Cash Flow Setup.Period Type", "Cash Flow Setup.SaveUserDefinedAPIKey", "Cash Flow Setup.GetMLCredentials", "Cash Flow Setup.RetrieveSaaSMLCredentials", "Cash Flow Setup.GetUserDefinedAPIKey"]

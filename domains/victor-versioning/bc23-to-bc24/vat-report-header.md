...
relevance_signals:
  constructs: ["VAT Report Version", "VAT Report Header", "VATReportHeader", "Date Type", "Additional Information"]
  keywords: []
  anti_pattern_indicators: ["VAT Report Header.VAT Report Version", "VAT Report Header.Date Type", "VAT Report Header.Additional Information"]

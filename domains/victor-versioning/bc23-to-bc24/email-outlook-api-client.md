---
title: "Email - Outlook API Client - 3 Obsoletions"
...
relevance_signals:
  constructs: ["GetAccountInformation", "Email - Outlook API Client", "Email-OutlookAPIClient", "TryGetAccountInformation", "SendEmail"]
  keywords: []
  anti_pattern_indicators: ["Email - Outlook API Client.GetAccountInformation", "Email - Outlook API Client.TryGetAccountInformation", "Email - Outlook API Client.SendEmail"]
  positive_pattern_indicators: []

applicable_object_types: ["codeunit"]
relevance_threshold: 0.6
---
# Email - Outlook API Client - 3 Obsoletions

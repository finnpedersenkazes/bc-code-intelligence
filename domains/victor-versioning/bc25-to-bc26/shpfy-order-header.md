...
relevance_signals:
  constructs: ["Sell-to Post Code", "Shpfy Order Header", "ShpfyOrderHeader", "Sell-to First Name", "Sell-to Last Name", "Cart Token", "Checkout Token", "Risk Level", "Fully Paid", "Checkout Id", "Discount Amount", "Bill-to County", "Ship-to County", "Company Location Id"]
  keywords: []
  anti_pattern_indicators: ["Shpfy Order Header.Sell-to Post Code", "Shpfy Order Header.Sell-to First Name", "Shpfy Order Header.Sell-to Last Name", "Shpfy Order Header.Cart Token", "Shpfy Order Header.Checkout Token", "Shpfy Order Header.Risk Level", "Shpfy Order Header.Fully Paid", "Shpfy Order Header.Checkout Id", "Shpfy Order Header.Discount Amount", "Shpfy Order Header.Bill-to County", "Shpfy Order Header.Ship-to County", "Shpfy Order Header.Company Location Id"]

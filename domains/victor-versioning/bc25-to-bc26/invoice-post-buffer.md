...
{'Object': 'Invoice Post. Buffer', 'State': 'Removed', 'Tag': '27.0', 'Reason': 'This table will be replaced by table Invoice Posting Buffer in new Invoice Posting implementation.'}

### table `Invoice Post. Buffer`
{'Object': 'Invoice Post. Buffer', 'State': 'Pending', 'Tag': '27.0', 'Reason': 'This table will be replaced by table Invoice Posting Buffer in new Invoice Posting implementation.'}

### procedure `PrepareSales`
{'Object': 'Invoice Post. Buffer', 'State': 'Pending', 'Tag': '20.0', 'Reason': 'Replaced by procedure in codeunit Sales Post Invoice'}
...
{'Object': 'Invoice Post. Buffer', 'State': 'Pending', 'Tag': '20.0', 'Reason': 'Replaced by procedure in codeunit Purch Post Invoice'}

### procedure `SetSalesTaxForSalesLine`
{'Object': 'Invoice Post. Buffer', 'State': 'Pending', 'Tag': '20.0', 'Reason': 'Replaced by procedure in codeunity Sales Post Invoice'}
...
{'Object': 'Invoice Post. Buffer', 'State': 'Pending', 'Tag': '20.0', 'Reason': 'Replaced by procedure in codeunit Service Post Invoice'}
...
{'Object': 'Invoice Post. Buffer', 'State': 'Pending', 'Tag': '20.0', 'Reason': 'This procedure is no longer invoked. Replaced by event in table Invoice Posting Buffer'}
